{{-- views/components/layout/guest.blade.php --}}
<!DOCTYPE html>
<html lang="id">
<head>
  <meta charset="utf-8">
...
{{-- DIUBAH: Ini adalah halaman login, jadi class-nya 'login-page' --}}
<body class="hold-transition login-page poliklinik-theme">

  {{-- Halaman 'guest' (login/register) tidak punya sidebar/header/footer --}}
  {{-- Dia hanya menampilkan konten (slot) --}}
  {{ $slot }}

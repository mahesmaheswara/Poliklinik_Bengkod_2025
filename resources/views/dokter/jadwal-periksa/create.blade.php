{{--resources/views/dokter/jadwal-periksa/create.blade.php--}}
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-header bg-white border-0 py-4">
                    <h3 class="card-title font-weight-bold text-dark mb-0">
                        <i class="fas fa-calendar-plus text-primary mr-2"></i> Formulir Jadwal Baru
                    </h3>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="status" id="status" class="form-control @error('status') is-invalid @enderror" required>
                                <option value="aktif" {{ old('status') == 'aktif' ? 'selected' : '' }}>Aktif (Menerima Pasien)</option>
                                <option value="non-aktif" {{ old('status') == 'non-aktif' ? 'selected' : '' }}>Non-Aktif (Cuti / Libur)</option>
                            </select>

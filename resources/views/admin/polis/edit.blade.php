{{-- views/admin/polis/edit.blade.php --}}
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-header bg-white border-0 py-4">
                    <h3 class="card-title font-weight-bold text-dark mb-0">
                        <i class="fas fa-edit text-primary mr-2"></i> Formulir Edit Poli
                    </h3>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea required name="keterangan" id="keterangan" rows="4"
                                      class="form-control @error('keterangan') is-invalid @enderror">{{ old('keterangan', $poli->keterangan) }}</textarea>
